...
public class NewCustomer {
    ...
    public NewCustomer(String Customer_name, String Meter_no, String Customer_address, String City, String State,
            String Cust_phone) {
    ...
    public NewCustomer(String Customer_name, String Meter_no, String Customer_address, String City, String State,
            String Cust_phone, String Meter_location, String Meter_type, String Phase_type, String Bill_type,String Days) {
        this.Customer_name = Customer_name;
        this.Meter_no = Meter_no;
        this.Customer_address = Customer_address;
        this.City = City;
